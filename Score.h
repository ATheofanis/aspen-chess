...
// attackers weight
constexpr int queenAttackerWeight = 10;
constexpr int rookAttackerWeight = 6;
constexpr int bishopAttackerWeight = 3;
constexpr int knightAttackerWeight = 3;
constexpr int pawnAttackerWeight = 1;
...
// MIDDLE GAME KNIGHT PST
constexpr int mgKnightPST[64] = {
...
// MIDDLE GAME BISHOP PST
constexpr int mgBishopPST[64] = {
...
// MIDDLE GAME ROOK PST
constexpr int mgRookPST[64] = {
...
// MIDDLE GAME QUEEN PST
constexpr int mgQueenPST[64] = {
